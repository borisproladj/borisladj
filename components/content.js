    ...
    <div className="hero absolute min-h-screen z-10">
      <div className="hero-content flex-col lg:flex-row">
        <div className="flex flex-col items-start justify-center h-screen">
          <div className="sm:absolute top-64 sm:text-8xl text-5xl font-bold text-left sm:animate-flyIn tracking-[0.15em]">
            CREATIVE
          </div>
        ...
        <div className="relative flex justify-center items-center w-full">
          ...
          <img
            src="profile.webp"
            className="rounded-full shadow-white sm:w-96 w-64 z-0 grayscale hover:grayscale-0 duration-300 hidden sm:block"
            alt="Profile"
          />
        </div>
      </div>
