  ...
  return (
    <div className="hero min-h-screen w-full p-2 lg:p-6 mb-20 z-20 md:mb-24 mx-auto text-white">
      ...
      >
        ...
        <div>
          <div
            className={`top-64 sm:text-6xl text-3xl font-bold text-center ${
              inView ? "animate-bottomFly" : "opacity-0"
            }`}
          >
            I AM A FULLSTACK DEVELOPER
          </div>
          <p
            className={`py-10 text-2xl text-center ${
              inView ? "animate-fadeIn" : "opacity-0"
            }`}
          >
            Hello, I'm Boris Ladyjensky, a passionate full-stack developer based
            in Israel.
            <br /> With a year of experience in web development, I thrive on
